/*
 * FLEET MANAGER MODULE (VIABARCAZAS STYLED)
 */

const FleetManagerViaBarcazas = (() => {

    let vessels = [];

    const init = () => {
        void("⚓ FleetManager (viabarcazasFleet): Iniciando...");
...
window.FleetManager = FleetManagerViaBarcazas;
