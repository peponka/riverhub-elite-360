...
const BackofficeModule = (() => {
            ...
            <div class="bo-container">
                ...
                <div class="bo-header">
                    <div class="bo-header-left">
                        ...
                        <div>
                            <h1 class="bo-title">VIABARCAZAS BACKOFFICE</h1>
    ...
    const loadUsers = async () => {
        ...
        if (users.length === 0) {
            users = [
                { id: '1', email: 'admin@viabarcazas.com', full_name: 'Carlos Martínez', role: 'superadmin', is_active: true, company: 'ViaBarcazas HQ' },
                        ...
                        <div class="bo-form-row">
                            ...
                            <div class="bo-form-group">
                                ...
                                <select id="bo-new-user-role" class="bo-input-full">
                                    ...
                                    <option value="superadmin">SuperAdmin Nivel ViaBarcazas</option>
                                </select>
                            </div>
                        </div>
                    </div>
