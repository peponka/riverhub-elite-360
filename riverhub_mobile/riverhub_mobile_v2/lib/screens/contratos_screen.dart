...
class _ContratosScreenState extends State<ContratosScreen> {
  ...
  Future<void> _loadContracts() async {
    try {
      ...
      if (mounted)
        setState(() {
          _contracts = List<Map<String, dynamic>>.from(res);
          _loading = false;
        });
    } catch (e) {
  ...
  int get _totalTonnage => _contracts.fold(
    0,
    (s, c) => s + ((c['volume_total'] as num?)?.toInt() ?? 0),
  );
  double get _totalRevenue => _contracts.fold(
    0.0,
    (s, c) =>
        s +
        (((c['volume_used'] as num?)?.toDouble() ?? 0) *
                ((c['rate_per_ton'] as num?)?.toDouble() ?? 0)) /
            1000,
  );
  int get _expiringCount => _contracts
      .where((c) => c['status'] == 'expires' || c['status'] == 'renewing')
      .length;
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: CupertinoNavigationBar(
        ...
        middle: Text(
          LocaleService.t('contratos_contratos'),
      ...
      child: SafeArea(
        child: _loading
            ...
            : ListView(
                ...
                children: [
                  Text(
                    LocaleService.t('contratos_contratos_de'),
                  ...
                  Text(
                    LocaleService.t('contratos_flete'),
                    style: GoogleFonts.newsreader(
                      fontSize: 34,
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: _kpi(
                          LocaleService.t('dyn_key_84'),
                          '${(_totalTonnage / 1000).round()}k',
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: _kpi(
                          'REVENUE',
                          '\$${_totalRevenue.toStringAsFixed(0)}k',
                  ...
                  // Contracts List
                  _sectionTitle(
                    LocaleService.t('dyn_key_72'),
                    '${_contracts.length} total',
                  ),
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Complete los datos del contrato de flete',
                    style: GoogleFonts.inter(
                      fontSize: 12,
                      color: AppColors.textSecondary,
                    ),
                  ...
                  CupertinoSlidingSegmentedControl<String>(
                    ...
                    children: const {
                      'COA Anual': Padding(
                        ...
                        child: Text('COA', style: TextStyle(fontSize: 11)),
                      ),
                      'Semestral': Padding(
                        padding: EdgeInsets.symmetric(
                          horizontal: 4,
                        ...
                        child: Text('Sem', style: TextStyle(fontSize: 11)),
                      ),
                      'Trimestral': Padding(
                        padding: EdgeInsets.symmetric(
                          horizontal: 4,
                        ...
                        child: Text('Trim', style: TextStyle(fontSize: 11)),
                      ),
                      'Spot': Padding(
                        padding: EdgeInsets.symmetric(
                          horizontal: 4,
                        ...
                        child: Text('Spot', style: TextStyle(fontSize: 11)),
                      ),
                    },
                    onValueChanged: (v) =>
                        setModalState(() => _selectedType = v ?? 'COA Anual'),
                  ),
                  const SizedBox(height: 12),
