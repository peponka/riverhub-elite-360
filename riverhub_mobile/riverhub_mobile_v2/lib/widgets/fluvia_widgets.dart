...
/// Fluvia-style navigation bar reusable across all screens
class FluviaNavBar extends CupertinoNavigationBar {
  FluviaNavBar({
    super.key,
...
/// Standard Fluvia page title (Newsreader serif split into two lines)
class FluviaTitle extends StatelessWidget {
  final String line1;
  final String line2;
...
/// Standard Fluvia KPI card
class FluviaKpiCard extends StatelessWidget {
  final String label;
  final String value;
...
/// Standard Fluvia list card
class FluviaListCard extends StatelessWidget {
  final IconData icon;
  final String title;
  final String subtitle;
  final VoidCallback? onTap;

  const FluviaListCard({
    super.key,
    required this.icon,
    required this.title,
...
class FluviaSectionHeader extends StatelessWidget {
  final String title;

  const FluviaSectionHeader({super.key, required this.title});
