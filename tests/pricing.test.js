...
test('catalogo contiene los seis combos sin planes ilimitados', () => {
    assert.deepEqual(PLANES.map((plan) => [plan.capacity, plan.monthlyPrice]), [[1,125],[10,1100],[25,2500],[50,4750],[100,9000],[150,12750]]);
});
test('barcazas y remolcadores usan exactamente la misma unidad facturable', () => {
    ...
    assert.equal(quote.savingsVsIndividual, 625);
});
